...
(function() {
  ...
  $.fn.validateCreditCard = function(callback) {
    var bind_validator, card_types, get_card_type, is_valid_length, is_valid_luhn, normalize, validate, validate_number;
    bind_validator = arguments[1] ? arguments[1] : true;
    card_types = [
      {
        name: 'amex',
        pattern: /^3[47]/,
